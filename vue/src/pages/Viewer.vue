<template>
    <div class="row">
        ...
        <div class="col-md-6">
            <iframe :src="mirador_path" seamless width="100%" height="850px" style="border: none;" class="ml-2"></iframe>
        </div>
        <div class="col-md-6">
                        ...
                        <div>
                            <div v-for="(line, line_id) of lines_org" :id="line_id" v-on:mouseover="mouseover" @click="clickSmoothScroll(line_id)">
                                ...
                                <div v-if="line.page" class="mr-2">
                                    ...
                                    <a target="_blank" :href="'https://japanknowledge.com/lib/display/?lid=80110V00200'+('000'+Number(line.page)).slice(-3)"><img width="30px" src="https://japanknowledge.com/apple-touch-icon-precomposed.png"></a>
                                </div>
...
export default {
    ...
    data() {
        return {
            url: "https://nakamura196.github.io/genji/tei/saga_001.xml",
            url_modern: "https://nakamura196.github.io/genji/tei/saga_modern2.xml",
            url_map: "https://api.myjson.com/bins/f0z3p",
            lines_org: {},
            lines_modern: {},
            id: "", //重要
            id_modern: "",
            modern_org_map: {},
            org_modern_map: {},
            mirador_path: "https://nakamura196.github.io/genji/mirador2/compare3?annotationlist=https://nakamura196.github.io/genji/ugm/utokyo/anno/anno_004_3423f58415e722cdcbe59823c9eb1467.json"
        }
    },
    created: function() {
    ...
    methods: {
        ...
        changeImage: function(target_id) {
            this.mirador_path = ""

            let query = " PREFIX sc: <http://iiif.io/api/presentation/2#> \n";
            query += " SELECT DISTINCT ?anno_id WHERE { \n";
            query += "  ?page rdfs:label \"" + target_id + "\"^^xsd:int . \n";
            query += "  ?page rdf:type <http://example.org/class/SagaPageID> . \n";
            ...
            axios.get("https://dydra.com/ut-digital-archives/genji/sparql?query=" + encodeURIComponent(query) + "&output=json")
                .then(response => {
                    ...
                    this.mirador_path = "https://nakamura196.github.io/genji/mirador2/compare3?annotationlist=" + result[0].anno_id.value
