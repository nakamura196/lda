    ...
    <div class="my-5">
        <div class="section">
            <div class="container">
                ...
                <h3 class="title">『新編日本古典文学全集』の頁数でさがす：p.{{$route.query.page}}</h3>
    
                <div class="text-right">
                    <a :href="comp_url" class="btn btn-round btn-primary mx-2">Miradorで比較する</a>
    
                    <a :href="'https://japanknowledge.com/lib/display/?lid=80110V00200'+('000'+Number($route.query.page)).slice(-3)" class="mx-2"><img height="45px" src="https://japanknowledge.com/apple-touch-icon-precomposed.png"></a>
                </div>
                ...
                <table class="table mt-5">
                    ...
                    <tbody>
                        <tr v-for="obj in result">
                            ...
                            <td>
                                <a :href="'https://nakamura196.github.io/genji/mirador2/compare3?annotationlist='+obj.anno_id.value.replace('ugm3', 'ugm4')"><img class="m-2" src="https://iiif.dl.itc.u-tokyo.ac.jp/images/mirador.png"></a>
...
export default {
    ...
    created: function() {
        ...
        query += "  ?page rdfs:label \"" + this.$route.query.page + "\"^^xsd:int . \n";
        ...
        axios.get("https://dydra.com/ut-digital-archives/genji/sparql?query=" + encodeURIComponent(query) + "&output=json")
            .then(response => {
                ...
                for (let i = 0; i < result.length; i++) {
                    let obj = result[i]
                    annotationlists += obj.anno_id.value.replace("ugm3", "ugm4") + ";"
                }
