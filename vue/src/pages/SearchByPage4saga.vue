    ...
    <div class="my-5">
        <div class="section">
            <div class="container">
                ...
                <h3 class="title">『新編日本古典文学全集』の頁数でさがす</h3>
                ...
                <table class="table mt-5">
                    ...
                    <tbody>
                        <tr v-for="obj in filteredUsers">
                            ...
                            <td>
                                <router-link class="btn btn-round btn-info" v-bind:to="{ path: 'listByPage4saga', query: { page: obj.plabel.value}}"><i class="fas fa-search"></i></router-link>
                            </td>
                            <td>
                                <a :href="'https://japanknowledge.com/lib/display/?lid=80110V00200'+('000'+Number(obj.plabel.value)).slice(-3)" class="mx-2"><img height="45px" src="https://japanknowledge.com/apple-touch-icon-precomposed.png"></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
